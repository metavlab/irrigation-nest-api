...
import { ResourceEntity } from 'src/core/entities';
import { CollectionsPermissionService } from '../../collections-resource/services/collections.permission.service';

@Injectable()
export class ResourceService {
  private resourceList:
    | Omit<ResourceEntity, 'id' | 'createdAt' | 'updatedAt' | 'updatedBy'>[]
    | undefined = [];
  constructor(
